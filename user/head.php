...
<head>
    <title> :: Lucknow Tution Point :: </title>
    ...
    <div>
        ...
        <tr>
            <td style="width:720px;text-align:left;">
                <img src="../images/logo.png" title="Lucknow Tution Point" />
            </td>

            <td style="width:250px;text-align:right;">
                <span class="head4"> Welcome </span><span style="color:red;"> user </span>
            </td>
    ...
    <div>
        ...
        <tr>
            ...
            <td style="width:125px;" class="nav">
                <a href="userIndex.php" class="style1"> Home </a>
            </td>
            <td style="width:130px;" class="nav">
                <a href="form.php" class="style1"> Online Form </a>
            </td>
            <td style="width:160px;" class="nav">
                <a href="apply.php" class="style1"> Apply Tution </a>
            </td>
            <td style="width:160px;" class="nav">
                <a href="status.php" class="style1"> Check Status </a>
            </td>
            <td style="width:130px;" class="nav">
                <a href="ebook.php" class="style1"> E-Book </a>
            </td>
            <td style="width:125px;" class="nav">
